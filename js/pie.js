...
function main() {
    ...
    // vis.append("svg:g").attr("class", "descrip")
    //     .selectAll("text")
    //     .data([1])
    //     .enter()
    //     .append("svg:text")
    //     .attr("transform", "translate(" + (visWidth * 2 + 30) + ",170)")
    //     .attr("class", "text")
    //     .style({
    //         "font-size": "10px",
    //         "word-wrap": "break-word"
    //     })
    //     .text("Album and soundtrack distribution to the review grades. Click the caption to switch the category. Zoom upon the graph to rotate it to get a better view.")
    //     .call(wrap, 50)
