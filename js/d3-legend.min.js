! function a(b, c, d) {
        ...
        ! function (a, d) {
            ...
            function p() {
                ...
                return a.value = function (c) {
                    return arguments.length ? (b = "function" == typeof c ? c : j(c), a) : b
                }, a.domain = function (b) {
                    return arguments.length ? (c = "function" == typeof b ? b : j([b[0], b[1]]), a) : c
                }, a.thresholds = function (b) {
                    return arguments.length ? (d = "function" == typeof b ? b : j(Array.isArray(b) ? K.call(b) : b), a) : d
                }, a
            }
            ...
            function r(a, c, d) {
                return a = L.call(a, f).sort(b), Math.ceil((d - c) / (2 * (q(a, .75) - q(a, .25)) * Math.pow(a.length, -1 / 3)))
            }

            function s(a, b, c) {
                return Math.ceil((c - b) / (3.5 * h(a) * Math.pow(a.length, -1 / 3)))
            }
            ...
            var G = c(b),
                ...
                N = Math.sqrt(10),
                O = Math.sqrt(2);
            a.bisect = H, a.bisectRight = H, a.bisectLeft = I, a.ascending = b, a.bisector = c, a.descending = e, a.deviation = h, a.extent = i, a.histogram = p, a.thresholdFreedmanDiaconis = r, a.thresholdScott = s, a.thresholdSturges = o, a.max = t, a.mean = u, a.median = v, a.merge = w, a.min = x, a.pairs = y, a.permute = z, a.quantile = q, a.range = l, a.scan = A, a.shuffle = B, a.sum = C, a.ticks = m, a.tickStep = n, a.transpose = D, a.variance = g, a.zip = F, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    2: [function (a, b, c) {
        ! function (a, d) {
            ...
            function c(a, c) {
                var d = new b;
                if (a instanceof b) a.each(function (a, b) {
                    d.set(b, a)
                });
            ...
            function i(a, b) {
                var c = new h;
                if (a instanceof h) a.each(function (a) {
                    c.add(a)
                });
                else if (a) {
                    var d = -1,
            ...
            b.prototype = c.prototype = {
                ...
                entries: function () {
                    var a = [];
                    for (var b in this) b[0] === j && a.push({
                        key: b.slice(1),
                        value: this[b]
                    });
                    return a
            ...
            var k = function () {
                    function a(b, d, e, f) {
                        if (d >= k.length) return null != i ? i(b) : null != h ? b.sort(h) : b;
                        for (var g, j, l, m = -1, n = b.length, o = k[d++], p = c(), q = e(); ++m < n;)(l = p.get(g = o(j = b[m]) + "")) ? l.push(j) : p.set(g, [j]);
                    ...
                    function b(a, c) {
                        ...
                        var d, e = l[c - 1];
                        return null != i && c >= k.length ? d = a.entries() : (d = [], a.each(function (a, e) {
                            d.push({
                                key: e,
                                values: b(a, c)
                            })
                        })), null != e ? d.sort(function (a, b) {
            ...
            a.nest = k, a.set = i, a.map = c, a.keys = m, a.values = n, a.entries = o, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    3: [function (a, b, c) {
        ! function (a, d) {
            ...
            function d(a) {
                var b;
                return a = (a + "").trim().toLowerCase(), (b = H.exec(a)) ? (b = parseInt(b[1], 16), new i(b >> 8 & 15 | b >> 4 & 240, b >> 4 & 15 | 240 & b, (15 & b) << 4 | 15 & b, 1)) : (b = I.exec(a)) ? e(parseInt(b[1], 16)) : (b = J.exec(a)) ? new i(b[1], b[2], b[3], 1) : (b = K.exec(a)) ? new i(255 * b[1] / 100, 255 * b[2] / 100, 255 * b[3] / 100, 1) : (b = L.exec(a)) ? f(b[1], b[2], b[3], b[4]) : (b = M.exec(a)) ? f(255 * b[1] / 100, 255 * b[2] / 100, 255 * b[3] / 100, b[4]) : (b = N.exec(a)) ? j(b[1], b[2] / 100, b[3] / 100, 1) : (b = O.exec(a)) ? j(b[1], b[2] / 100, b[3] / 100, b[4]) : P.hasOwnProperty(a) ? e(P[a]) : "transparent" === a ? new i(NaN, NaN, NaN, 0) : null
            }
            ...
            function g(a) {
                return a instanceof c || (a = d(a)), a ? (a = a.rgb(), new i(a.r, a.g, a.b, a.opacity)) : new i
            }

            function h(a, b, c, d) {
                return 1 === arguments.length ? g(a) : new i(a, b, c, null == d ? 1 : d)
            }
            ...
            function l(a, b, c, d) {
                return 1 === arguments.length ? k(a) : new m(a, b, c, null == d ? 1 : d)
            }
            ...
            function o(a) {
                ...
                if (a instanceof x) {
                    var b = a.h * Q;
                    return new q(a.l, Math.cos(b) * a.c, Math.sin(b) * a.c, a.opacity)
                }
            ...
            function p(a, b, c, d) {
                return 1 === arguments.length ? o(a) : new q(a, b, c, null == d ? 1 : d)
            }
            ...
            function w(a, b, c, d) {
                return 1 === arguments.length ? v(a) : new x(a, b, c, null == d ? 1 : d)
            }
            ...
            B(c, d, {
                ...
                brighter: function (a) {
                    return a = null == a ? D : Math.pow(D, a), new i(this.r * a, this.g * a, this.b * a, this.opacity)
                },
                darker: function (a) {
                    return a = null == a ? C : Math.pow(C, a), new i(this.r * a, this.g * a, this.b * a, this.opacity)
                },
                rgb: function () {
                    return this
                },
                ...
                brighter: function (a) {
                    return a = null == a ? D : Math.pow(D, a), new m(this.h, this.s, this.l * a, this.opacity)
                },
                darker: function (a) {
                    return a = null == a ? C : Math.pow(C, a), new m(this.h, this.s, this.l * a, this.opacity)
                },
                rgb: function () {
            ...
            B(q, p, b(c, {
                brighter: function (a) {
                    return new q(this.l + S * (null == a ? 1 : a), this.a, this.b, this.opacity)
                },
                darker: function (a) {
                    return new q(this.l - S * (null == a ? 1 : a), this.a, this.b, this.opacity)
                },
                ...
                brighter: function (a) {
                    return new x(this.h, this.c, this.l + S * (null == a ? 1 : a), this.opacity)
                },
                darker: function (a) {
                    return new x(this.h, this.c, this.l - S * (null == a ? 1 : a), this.opacity)
                },
            ...
            B(A, z, b(c, {
                brighter: function (a) {
                    return a = null == a ? D : Math.pow(D, a), new A(this.h, this.s, this.l * a, this.opacity)
                },
                darker: function (a) {
                    return a = null == a ? C : Math.pow(C, a), new A(this.h, this.s, this.l * a, this.opacity)
                },
                rgb: function () {
            ...
            })), a.color = d, a.rgb = h, a.hsl = l, a.lab = p, a.hcl = w, a.cubehelix = z, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    4: [function (a, b, c) {
        ! function (a, d) {
            ...
            }, a.dispatch = b, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    5: [function (a, b, c) {
        ! function (a, d) {
            ...
            function k(a) {
                function b(a) {
                        ...
                        if ("c" === o) q = u(a) + q, a = "";
                            ...
                            if (a = u(a, n), w)
                                for (b = -1, g = a.length, w = !1; ++b < g;)
                                    if (h = a.charCodeAt(b), 48 < h && h < 58 || "x" === o && 96 < h && h < 103 || "X" === o && 64 < h && h < 71) {
                                        w = !0;
                                        break
                                    } if (j = (w ? "(" === e ? e : "-" : "-" === e || "(" === e ? "" : e) + j, q = q + ("s" === o ? t[8 + p / 3] : "") + (w && "(" === e ? ")" : ""), v)
                                for (b = -1, g = a.length; ++b < g;)
                                    if (h = a.charCodeAt(b), 48 > h || h > 57) {
                                        q = (46 === h ? i + a.slice(b + 1) : a.slice(b)) + q, a = a.slice(0, b);
                                        break
                                    }
                        }
                        m && !k && (a = f(a, 1 / 0));
                    ...
                    var c = a.fill,
                        ...
                        u = q[o],
                        v = !o || /[defgprs%]/.test(o);
                    return n = null == n ? o ? 6 : 12 : /[gprs]/.test(o) ? Math.max(1, Math.min(21, n)) : Math.max(0, Math.min(20, n)), b.toString = function () {
                        return a + ""
                    }, b
                }
            ...
            function l(b) {
                return s = k(b), a.format = s.format, a.formatPrefix = s.formatPrefix, s
            }
            ...
            function n(a, b) {
                return Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(c(b) / 3))) - c(Math.abs(a)))
            }

            function o(a, b) {
                return a = Math.abs(a), b = Math.abs(b) - a, Math.max(0, c(b) - c(a)) + 1
            }
            var p, q = {
                    "": e,
                    "%": function (a, b) {
            ...
            l({
                ...
                grouping: [3],
                currency: ["$", ""]
            }), a.formatDefaultLocale = l, a.formatLocale = k, a.formatSpecifier = h, a.precisionFixed = m, a.precisionPrefix = n, a.precisionRound = o, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    6: [function (a, b, c) {
        ! function (d, e) {
            "object" == typeof c && "undefined" != typeof b ? e(c, a("d3-color")) : "function" == typeof define && define.amd ? define(["exports", "d3-color"], e) : e(d.d3 = d.d3 || {}, d.d3)
        }(this, function (a, b) {
            "use strict";
            ...
            function f(a, b) {
                var c = b - a;
                return c ? d(a, c > 180 || c < -180 ? c - 360 * Math.round(c / 360) : c) : B(isNaN(a) ? b : a)
            }
            ...
            function l(a) {
                return "none" === a ? P : (v || (v = document.createElement("DIV"), w = document.documentElement, x = document.defaultView), v.style.transform = a, a = x.getComputedStyle(w.appendChild(v), null).getPropertyValue("transform"), w.removeChild(v), a = a.slice(7, -1).split(","), Q(+a[0], +a[1], +a[2], +a[3], +a[4], +a[5]))
            }

            function m(a) {
                return null == a ? P : (y || (y = document.createElementNS("http://www.w3.org/2000/svg", "g")), y.setAttribute("transform", a), (a = y.transform.baseVal.consolidate()) ? (a = a.matrix, Q(a.a, a.b, a.c, a.d, a.e, a.f)) : P)
            }
            ...
            function r(a) {
                return function (c, d) {
                    ...
                    return function (a) {
                        return c.h = e(a), c.s = f(a), c.l = g(a), c.opacity = i(a), c + ""
                    }
                }
            }
            ...
            function s(a, c) {
                ...
                return function (b) {
                    return a.l = d(b), a.a = e(b), a.b = f(b), a.opacity = g(b), a + ""
                }
            }
            ...
            function t(a) {
                return function (c, d) {
                    var e = a((c = b.hcl(c)).h, (d = b.hcl(d)).h),
                        ...
                        i = h(c.opacity, d.opacity);
                    return function (a) {
                        return c.h = e(a), c.c = f(a), c.l = g(a), c.opacity = i(a), c + ""
                    }
                }
            }
            ...
            function u(a) {
                return function c(d) {
                    function e(c, e) {
                        ...
                        return function (a) {
                            return c.h = f(a), c.s = g(a), c.l = i(Math.pow(a, d)), c.opacity = j(a), c + ""
                        }
                    }
            ...
            var v, w, x, y, z = function (a) {
                ...
                C = function a(c) {
                    function d(a, c) {
                        ...
                        return function (b) {
                            return a.r = d(b), a.g = f(b), a.b = g(b), a.opacity = h(b), a + ""
                        }
                    }
                    var e = g(c);
                    return d.gamma = a, d
                ...
                L = function (a, b) {
                    var c, d, e, f = J.lastIndex = K.lastIndex = 0,
                        ...
                        i = [];
                    for (a += "", b += "";
                        (c = J.exec(a)) && (d = K.exec(b));)(e = d.index) > f && (e = b.slice(f, e), h[g] ? h[g] += e : h[++g] = e), (c = c[0]) === (d = d[0]) ? h[g] ? h[g] += d : h[++g] = d : (h[++g] = null, i.push({
                        i: g,
                        x: H(c, d)
                    })), f = K.lastIndex;
                    return f < b.length && (e = b.slice(f), h[g] ? h[g] += e : h[++g] = e), h.length < 2 ? i[0] ? k(i[0].x) : j(b) : (b = i.length, function (a) {
                ...
                M = function (a, c) {
                    var d, e = typeof c;
                    return null == c || "boolean" === e ? B(c) : ("number" === e ? H : "string" === e ? (d = b.color(c)) ? (c = d, C) : L : c instanceof b.color ? C : c instanceof Date ? G : Array.isArray(c) ? F : isNaN(c) ? I : H)(a, c)
                },
                N = function (a, b) {
                    return a = +a, b -= a,
                        function (c) {
                ...
                X = function (a, b) {
                    var c, d, e = a[0],
                        ...
                        l = i - f,
                        m = k * k + l * l;
                    if (m < W) d = Math.log(j / g) / T, c = function (a) {
    ...
    7: [function (a, b, c) {
        ! function (d, e) {
            "object" == typeof c && "undefined" != typeof b ? e(c, a("d3-array"), a("d3-collection"), a("d3-interpolate"), a("d3-format"), a("d3-time"), a("d3-time-format"), a("d3-color")) : "function" == typeof define && define.amd ? define(["exports", "d3-array", "d3-collection", "d3-interpolate", "d3-format", "d3-time", "d3-time-format", "d3-color"], e) : e(d.d3 = d.d3 || {}, d.d3, d.d3, d.d3, d.d3, d.d3, d.d3, d.d3)
            ...
            function i(a) {
                ...
                return a = null == a ? [] : Y.call(a), b.domain = function (a) {
                    ...
                    return i().domain(e).range(a).unknown(f)
                }, b
            }
            ...
            function j() {
                ...
                var c, d, e = i().unknown(void 0),
                    ...
                    m = 0,
                    n = .5;
                return delete e.unknown, e.domain = function (b) {
                    return arguments.length ? (f(b), a()) : f()
                }, e.range = function (b) {
                    return arguments.length ? (h = [+b[0], +b[1]], a()) : h.slice()
                    ...
                    return arguments.length ? (l = m = Math.max(0, Math.min(1, b)), a()) : l
                    ...
                    return arguments.length ? (n = Math.max(0, Math.min(1, b)), a()) : n
                }, e.copy = function () {
                    return j().domain(f()).range(h).round(k).paddingInner(l).paddingOuter(m).align(n)
                }, a()
            }
            ...
            function u(a, b) {
                function c() {
                    return f = Math.min(i.length, j.length) > 2 ? s : r, g = h = null, e
                }
            ...
            function D(a) {
                return 10 === a ? C : a === Math.E ? Math.exp : function (b) {
                    return Math.pow(a, b)
                }
            }
            ...
            function G() {
                function a() {
                    return g = E(f), h = D(f), d()[0] < 0 && (g = F(g), h = F(h)), c
                }
            ...
            function I() {
                function a(a, b) {
                    return (b = H(b, c) - (a = H(a, c))) ? function (d) {
                        return (H(d, c) - a) / b
                    } : m(b)
                }
            ...
            function K() {
                ...
                var d = [],
                    e = [],
                    f = [];
                return c.invertExtent = function (a) {
                    var b = e.indexOf(a);
                    return b < 0 ? [NaN, NaN] : [b > 0 ? f[b - 1] : d[0], b < f.length ? f[b] : d[d.length - 1]]
                }, c.domain = function (c) {
            ...
            function L() {
                ...
                function c() {
                    var b = -1;
                    for (g = new Array(f); ++b < f;) g[b] = ((b + 1) * e - (b - f) * d) / (f + 1);
                    return a
                }
                var d = 0,
                    e = 1,
                ...
                return a.domain = function (a) {
                    ...
                    return arguments.length ? (f = (h = Y.call(a)).length - 1, c()) : h.slice()
                }, a.invertExtent = function (a) {
                    var b = h.indexOf(a);
                    return b < 0 ? [NaN, NaN] : b < 1 ? [d, g[0]] : b >= f ? [g[f - 1], e] : [g[b - 1], g[b]]
                }, a.copy = function () {
                    return L().domain([d, e]).range(h)
                }, w(a)
            }
            ...
            function M() {
                ...
                var c = [.5],
                    d = [0, 1],
                    e = 1;
                return a.domain = function (b) {
                    return arguments.length ? (c = Y.call(b), e = Math.min(c.length, d.length - 1), a) : c.slice()
                }, a.range = function (b) {
                    return arguments.length ? (d = Y.call(b), e = Math.min(c.length, d.length - 1), a) : d.slice()
                }, a.invertExtent = function (a) {
                    var b = d.indexOf(a);
                    return [c[b - 1], c[b]]
                }, a.copy = function () {
                    return M().domain(c).range(d)
                }, a
            }
            ...
            function P(a, c, e, f, g, h, i, j, k) {
                function l(b) {
                    return (i(b) < b ? r : h(b) < b ? s : g(b) < b ? v : f(b) < b ? w : c(b) < b ? e(b) < b ? x : y : a(b) < b ? A : B)(b)
                }

                function m(c, d, e, f) {
                    if (null == c && (c = 10), "number" == typeof c) {
                        var g = Math.abs(e - d) / c,
                            h = b.bisector(function (a) {
                                return a[2]
                            }).right(C, g);
            ...
            function Q() {
                return P(f.timeYear, f.timeMonth, f.timeWeek, f.timeDay, f.timeHour, f.timeMinute, f.timeSecond, f.timeMillisecond, g.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)])
            }

            function R() {
                return P(f.utcYear, f.utcMonth, f.utcWeek, f.utcDay, f.utcHour, f.utcMinute, f.utcSecond, f.utcMillisecond, g.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)])
            }
    ...
    8: [function (a, b, c) {
        ! function (a, d) {
            ...
            function b(a) {
                var b = a += "",
                    c = b.indexOf(":");
                return c >= 0 && "xmlns" !== (b = a.slice(0, c)) && (a = a.slice(c + 1)), Qa.hasOwnProperty(b) ? {
                    space: Qa[b],
                    local: a
                } : a
            }
            ...
            function m(a, b, c) {
                var d, e, f = j(a + ""),
                    g = f.length; {
                    if (!(arguments.length < 2)) {
                        for (h = b ? l : k, null == c && (c = !1), d = 0; d < g; ++d) this.each(h(f[d], b, c));
                        return this
                    }
            ...
            function C(a, b, c, d, e, f) {
                for (var g, h = 0, i = b.length, j = f.length; h < j; ++h)(g = b[h]) ? (g.__data__ = f[h], d[h] = g) : c[h] = new A(a, f[h]);
            ...
            function W(a, c) {
                ...
                return this.each((null == c ? d.local ? R : Q : "function" == typeof c ? d.local ? V : U : d.local ? T : S)(d, c))
            }
            ...
            function _(a, b, c) {
                var d;
                return arguments.length > 1 ? this.each((null == b ? Y : "function" == typeof b ? $ : Z)(a, b, null == c ? "" : c)) : X(d = this.node()).getComputedStyle(d, null).getPropertyValue(a)
            }
            ...
            function da(a, b) {
                return arguments.length > 1 ? this.each((null == b ? aa : "function" == typeof b ? ca : ba)(a, b)) : this.node()[a]
            }
            ...
            function qa(a) {
                return arguments.length ? this.each(null == a ? na : ("function" == typeof a ? pa : oa)(a)) : this.node().textContent
            }
            ...
            function ua(a) {
                return arguments.length ? this.each(null == a ? ra : ("function" == typeof a ? ta : sa)(a)) : this.node().innerHTML
            }
            ...
            function Ma(a) {
                return "string" == typeof a ? new Ja([document.querySelectorAll(a)], [document.documentElement]) : new Ja([null == a ? [] : a], Za)
            }
            ...
            function Oa(a, b) {
                null == b && (b = o().touches);
                for (var c = 0, d = b ? b.length : 0, e = new Array(d); c < d; ++c) e[c] = p(a, b[c]);
                return e
            }
            ...
            Ja.prototype = Ka.prototype = {
                ...
                on: m,
                dispatch: Ia
            }, a.creator = e, a.local = f, a.matcher = Va, a.mouse = q, a.namespace = b, a.namespaces = Qa, a.select = La, a.selectAll = Ma, a.selection = Ka, a.selector = s, a.selectorAll = v, a.touch = Na, a.touches = Oa, a.window = X, a.customEvent = n, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {}],
    9: [function (a, b, c) {
        ! function (d, e) {
            "object" == typeof c && "undefined" != typeof b ? e(c, a("d3-time")) : "function" == typeof define && define.amd ? define(["exports", "d3-time"], e) : e(d.d3 = d.d3 || {}, d.d3)
        }(this, function (a, b) {
            "use strict";
            ...
            function f(a) {
                ...
                function g(a, b, c, d) {
                    for (var e, f, g = 0, h = b.length, i = c.length; g < h;) {
                        ...
                        if (e = b.charCodeAt(g++),
                            37 === e) {
                            if (e = b.charAt(g++), f = La[e in da ? b.charAt(g++) : e], !f || (d = f(a, c, d)) < 0) return -1
                ...
                return Ja.x = b(sa, Ja), Ja.X = b(ta, Ja), Ja.c = b(ra, Ja), Ka.x = b(sa, Ka), Ka.X = b(ta, Ka), Ka.c = b(ra, Ka), {
                    format: function (a) {
                        var c = b(a += "", Ja);
            ...
            function L(a) {
                ...
                return (b > 0 ? "-" : (b *= -1, "+")) + g(b / 60 | 0, "0", 2) + g(b % 60, "0", 2)
            }
            ...
            function _(b) {
                return ca = f(b), a.timeFormat = ca.format, a.timeParse = ca.parse, a.utcFormat = ca.utcFormat, a.utcParse = ca.utcParse, ca
            }
            ...
            a.timeFormatDefaultLocale = _, a.timeFormatLocale = f, a.isoFormat = ia, a.isoParse = ja, Object.defineProperty(a, "__esModule", {
                value: !0
            })
        })
    }, {
    ...
    10: [function (a, b, c) {
        ! function (a, d) {
            ...
            function b(a, c, d, g) {
                ...
                return h.floor = h, h.ceil = function (b) {
                ...
                }, d && (h.count = function (b, c) {
                    return e.setTime(+b), f.setTime(+c), a(e), a(f), Math.floor(d(e, f))
                }, h.every = function (a) {
                    return a = Math.floor(a), isFinite(a) && a > 0 ? a > 1 ? h.filter(g ? function (b) {
                        return g(b) % a === 0
                    } : function (b) {
            ...
            function c(a) {
                return b(function (b) {
                    ...
                    return (b - a - (b.getTimezoneOffset() - a.getTimezoneOffset()) * j) / m
                })
            }
            ...
            var e = new Date,
                f = new Date,
                g = b(function () {}, function (a, b) {
                    a.setTime(+a + b)
                }, function (a, b) {
                    return b - a
                });
            g.every = function (a) {
                return a = Math.floor(a), isFinite(a) && a > 0 ? a > 1 ? b(function (b) {
            ...
            var h = g.range,
                ...
                t = b(function (a) {
                    ...
                    return (b - a - (b.getTimezoneOffset() - a.getTimezoneOffset()) * j) / l
                }, function (a) {
                    return a.getDate() - 1
                }),
                u = t.range,
            ...
            L.every = function (a) {
                return isFinite(a = Math.floor(a)) && a > 0 ? b(function (b) {
    ...
    11: [function (a, b, c) {
        ...
        function e() {
            function a(a) {
                ...
                q ? D.attr("class", function (a) {
                    return p + "swatch " + h.feature(a)
                }) : "line" == c ? D.style("stroke", h.feature) : D.style("fill", h.feature);
                var H = void 0,
                    I = void 0,
                ...
                "vertical" === x ? ! function () {
                    ...
                    H = function (b, c) {
                        ...
                        return "translate( " + (G[b].width + G[b].x + t) + ", " + (G[b].y + G[b].height / 2 + 5) + ")"
                    }
                }() : "horizontal" === x && (H = function (a, b) {
                    return "translate(" + b * (G[b].width + l) + ",0)"
                }, I = function (a, b) {
                    return "translate(" + (G[b].width * J + G[b].x) + ",\n          " + (G[b].height + G[b].y + t + 8) + ")"
                }), g.default.d3_placement(x, j, H, E, I, u), g.default.d3_title(a, r, p, A), j.transition().style("opacity", 1)
            }
            ...
            return a.scale = function (c) {
                ...
                return arguments.length ? ((b.length > 1 || b >= 2) && (m = b), a) : m
            }, a.cellFilter = function (b) {
                return arguments.length ? (n = b, a) : n
            }, a.shape = function (b, d) {
                return arguments.length ? (("rect" == b || "circle" == b || "line" == b || "path" == b && "string" == typeof d) && (c = b, z = d), a) : c
                ...
                return arguments.length ? ("start" != b && "end" != b && "middle" != b || (u = b), a) : u
            }, a.labelFormat = function (b) {
                return arguments.length ? (s = "string" == typeof b ? (0, j.format)(b) : b, a) : s
                ...
                return arguments.length ? (b !== !0 && b !== !1 || (q = b), a) : q
            }, a.orient = function (b) {
                return arguments.length ? (b = b.toLowerCase(), "horizontal" != b && "vertical" != b || (x = b), a) : x
    ...
    13: [function (a, b, c) {
        ...
        var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (a) {
            ...
            g = function (a) {
                for (var b = [], c = 0, d = a.length; c < d; c++) b[c] = a[d - c - 1];
                return b
            },
            h = function (a, b) {
                a.each(function () {
                    for (var a, c = (0, e.select)(this), d = c.text().split(/\s+/).reverse(), f = [], g = 1.2, h = (c.attr("y"), parseFloat(c.attr("dy")) || 0), i = c.text(null).append("tspan").attr("x", 0).attr("dy", h + "em"); a = d.pop();) f.push(a), i.text(f.join(" ")), i.node().getComputedTextLength() > b && f.length > 1 && (f.pop(), i.text(f.join(" ")), f = [a], i = c.append("tspan").attr("x", 0).attr("dy", g + h + "em").text(a))
                })
            },
            i = function () {
                ...
                if ("function" == typeof b) {
                    for (var g = [], h = a.length, i = 0; i < h; i++) g.push(b({
                        i: i,
                        genLength: h,
                        generatedLabels: a,
                        domain: c,
        ...
        c.default = {
            ...
            d3_addText: function (a, b, c, d, e) {
                ...
                var g = a.selectAll("g." + d + "cell text." + d + "label").data(c).text(f);
                return e && a.selectAll("g." + d + "cell text." + d + "label").call(h, e), g
            },
            ...
            d3_filterCells: function (a, b) {
                ...
                return a.data = a.data.filter(function (a) {
            ...
            d3_title: function (a, b, c, d) {
                if ("" !== b) {
                    ...
                    var f = a.select("." + c + "legendCells"),
                        g = a.select("." + c + "legendTitle").nodes().map(function (a) {
        ...
        function e() {
            function a(a) {
                ...
                "vertical" === u ? ! function () {
                    ...
                    return "translate( " + (D[b].width * I + D[b].x) + ",\n              " + (E + q) + ")"
                }), g.default.d3_placement(u, j, G, B, H, r), g.default.d3_title(a, o, n, x), j.transition().style("opacity", 1)
            }
            var b = (0, i.scaleLinear)(),
                c = "rect",
                d = 15,
            ...
            return a.scale = function (c) {
                ...
                return arguments.length ? ((b.length > 1 || b >= 2) && (f = b), a) : f
            }, a.cellFilter = function (b) {
                return arguments.length ? (l = b, a) : l
            }, a.shape = function (b, d) {
                return arguments.length ? ("rect" != b && "circle" != b && "line" != b || (c = b, w = d), a) : c
            }, a.shapeWidth = function (b) {
                return arguments.length ? (d = +b, a) : d
            }, a.shapePadding = function (b) {
                return arguments.length ? (e = +b, a) : e
                ...
                return arguments.length ? ("start" != b && "end" != b && "middle" != b || (r = b), a) : r
            }, a.labelFormat = function (b) {
                return arguments.length ? (p = "string" == typeof b ? (0, j.format)(b) : b, a) : p
            }, a.labelOffset = function (b) {
                ...
                return arguments.length ? (b = b.toLowerCase(), "horizontal" != b && "vertical" != b || (u = b), a) : u
            }, a.ascending = function (b) {
                return arguments.length ? (v = !!b, a) : v
            }, a.classPrefix = function (b) {
                return arguments.length ? (n = b, a) : n
    ...
    15: [function (a, b, c) {
        ...
        function e() {
            function a(a) {
                ...
                "vertical" === w ? ! function () {
                    ...
                    H = function (b, c) {
                        ...
                        return "translate( " + (G + t) + ",\n              " + (E[b].y + E[b].height / 2 + 5) + ")"
                    }
                }() : "horizontal" === w && (H = function (a, b) {
                    return "translate( " + b * (G + l) + ",0)"
                }, I = function (a, b) {
                    return "translate( " + (E[b].width * J + E[b].x) + ",\n              " + (F + t) + ")"
                }), g.default.d3_placement(w, j, H, C, I, s), g.default.d3_title(a, q, p, y), j.transition().style("opacity", 1)
            }
            var b = (0, i.scaleLinear)(),
                c = "path",
                d = 15,
            ...
            return a.scale = function (c) {
                ...
                return arguments.length ? ("start" != b && "end" != b && "middle" != b || (s = b), a) : s
            }, a.labelFormat = function (b) {
                return arguments.length ? (r = "string" == typeof b ? (0, j.format)(b) : b, a) : r
            }, a.labelOffset = function (b) {
                return arguments.length ? (t = +b, a) : t
            }, a.labelDelimiter = function (b) {
                ...
                return arguments.length ? (b = b.toLowerCase(), "horizontal" != b && "vertical" != b || (w = b), a) : w
            }, a.ascending = function (b) {
                return arguments.length ? (x = !!b, a) : x
            }, a.classPrefix = function (b) {
                return arguments.length ? (p = b, a) : p
